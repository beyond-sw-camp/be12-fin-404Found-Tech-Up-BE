...
- `연관성 높은 제품 추천` : 사용자가 등록하거나 사이트에서 구매한 자신의 제품에 관한 데이터를 분석하여 연관 제품을 제안하고, 사용자의 현재 제품 사양에 기반하여 간단한 업그레이드(예: RAM 용량 증가, SSD 용량 확장, CPU 코어 수 증가 등) 중심으로 추천하는 데 중점을 둔다.
...
## 📚 백엔드 프로젝트 목표
- `API 설계 및 개발` 
    - 클라이언트(프론트엔드)에서 호출할 수 있도록 RESTful API 또는 GraphQL API를 설계하고 개발합니다.
    - HTTP 메서드(GET, POST, PUT, DELETE 등)를 명확히 구분하여 표준에 맞는 엔드포인트 구조를 구성합니다.
    - Swagger를 활용해 API 문서화를 지원하며, 프론트엔드와의 협업을 원활하게 합니다.
- `추천 시스템 구현`
    - 추천 결과는 ElasticSearch와 연동하여 고속 검색 및 필터링이 가능하도록 설계합니다.
- `성능 최적화`
  - `Redis`
      - 선착순 처리 로직 (쿠폰 및 재고 관리)에 Redis를 사용해 빠른 읽기/쓰기 처리를 지원합니다.
...
<details>
<summary>내 제품 등록</summary>
    
### 사용자가 소유한 제품 정보의 등록
    
![스크린샷 2025-05-19 170708](https://github.com/user-attachments/assets/bae98c87-5ba1-4428-aaa1-9ba8b4a653f1)
...
![스크린샷 2025-05-19 170727](https://github.com/user-attachments/assets/2539b93b-4716-4965-b19b-23e7b42e72c1)
...
![스크린샷 2025-05-19 174828](https://github.com/user-attachments/assets/4c32b11e-0064-470e-9a65-3ba69e5524ec)

![스크린샷 2025-05-19 174908](https://github.com/user-attachments/assets/cef8c640-03e0-495b-bc13-e5d0db5e69ee)

![스크린샷 2025-05-19 174922](https://github.com/user-attachments/assets/049a33c7-4fb4-475a-bfd9-42a93585a153)
...
![스크린샷 2025-05-19 174701](https://github.com/user-attachments/assets/1f0f8f3b-318a-4f32-bc62-d996d434eba7)
...
---
### 주문 관리
![스크린샷 2025-05-19 175011](https://github.com/user-attachments/assets/955ccb9e-73ea-4413-a6b1-914e959d216b)

> 사용자 관리 페이지에서 단순 조회/검색 등으로 사이트에 등록한 사용자 목록을 요청할 경우 백엔드 서버는 전체 목록일 경우 페이지네이션이 된 결과를 반환하고, 검색의 경우 전체 목록을 반환한다.

![스크린샷 2025-05-19 175103](https://github.com/user-attachments/assets/93e79226-cfe5-444a-bb1c-b34059ea65fa)

![스크린샷 2025-05-19 175135](https://github.com/user-attachments/assets/afb98d45-6653-4cb8-81fb-427f384d811b)
...
![스크린샷 2025-05-19 175323](https://github.com/user-attachments/assets/4a1e80c1-e4b6-4478-8f35-73ead8dd6038)
